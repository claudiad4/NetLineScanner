...
namespace NetLine.Infrastructure.Migrations
{
    ...
    [Migration("20260419120000_AddPerTierScanTimestamps")]
    partial class AddPerTierScanTimestamps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetLine.Domain.Entities.DeviceInfo", b =>
                {
                    ...
                    b.Property<DateTime?>("LastHeavyScanAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("LastLightScanAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("LastMediumScanAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("NetLine.Domain.Entities.DeviceMetric", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("DeviceInfoId", "Timestamp");

                    b.HasIndex("DeviceInfoId", "MetricKey", "Timestamp");
            ...
            modelBuilder.Entity("NetLine.Infrastructure.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NetLine.Infrastructure.AppUser", null)
                        .WithMany()
